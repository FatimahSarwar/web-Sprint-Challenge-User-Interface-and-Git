...
-Semantic HTML is used to give eleemnts meaning to its style.
2. Name two big differences between ```display: block;``` and ```display: inline;```.
display block ill have spacing, display in-line will not as it will appear in one line.
...
-Git is valuable because it allows smoother collaboration, privacy enforced, enforces organization.
